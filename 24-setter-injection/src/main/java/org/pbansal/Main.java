...
public class Main {
    public static void main(String[] args) {
        ...
        taxReport.setCalculator(new TaxCalculator2020(160_000));
        taxReport.show();
    }
}
...
// this code is to demonstrate the concept one of the ways of dependency injection. - This is an example of setter injection.
...
// Setter Injection
// In the above example we have called this setCalculator setter method on the existing TaxReport object in line no. 10.
// This is useful if you have a couple of classes which are implementing the same interface.
